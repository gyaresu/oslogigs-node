This effort has come from a desire to learn about Node.js so I spent a weekend going through the tutorial at [Node Beginner](http://nodebeginner.org) (which I recommend).
